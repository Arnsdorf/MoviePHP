...
if(!empty($_POST["data"])){
    ...
    $sql = "INSERT INTO movie (movieTitel, movieYear, movieInstructor, movieDuration, movieGenre, movieIMDB, movieDiscription, movieActors, movieOscars, movieTotalGross) VALUES (:movieTitel, :movieYear, :movieInstructor, :movieDuration, :movieGenre, :movieIMDB, :movieDiscription, :movieActors, :movieOscars, :movieTotalGross)";
    $bind = [":movieTitel" => $data["movieTitel"], ":movieYear" => $data["movieYear"], ":movieInstructor" => $data["movieInstructor"], ":movieDuration" => $data["movieDuration"], ":movieGenre" => $data["movieGenre"], ":movieIMDB" => $data["movieIMDB"], ":movieDiscription" => $data["movieDiscription"], ":movieActors" => $data["movieActors"], ":movieOscars" => $data["movieOscars"], ":movieOscars" => $data["movieOscars"], ":movieTotalGross" => $data["movieTotalGross"]];
    ...
    <div class="row m-0">
        ...
        <div class="col-12 col-md-6 p-5">
            <div class="form-group">
                ...
                <input class="form-control shadow" type="number" name="data[movieDuration]" id="movieDuration" placeholder="Varighed" value="">
            </div>
        </div>
